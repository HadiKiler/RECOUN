        ...
        for line in txt:
            ...
            if line.rstrip() != "":
                try:
                    ...
                    with open('data\\subdomain+code+title.txt', 'a') as file:  
                        file.write(
                            line.rstrip() + f' {response.status_code} ' + title + os.linesep)
                except:
                    pass
            ...
            if domain.rstrip() != "":
                try:
                    ...
                    with open('data\\subdomain+ip+port.txt', 'a') as ip_port:  # domain+ip+ports
                        ip_port.write(domain.rstrip() + "   " + ip +
                                    "   " + str(ativePort) + os.linesep)
                except:
                    pass
            ...
            if domain.rstrip() != "":
                try:
                    response = requests.get(
                        "https://"+domain.rstrip(), verify=False)
                except:
                    pass
                ...
                with open("data\\subdomain+phone+email.txt", "a") as adress:
                    adress.write(domain.rstrip() + "   emails" +
                                 str(emails) + "  Numbers" + str(phones) + os.linesep)
